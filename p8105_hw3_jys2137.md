...
each minute in that day. Thus, this might not actually have any inherent
value in relation to figuring out whether there are trends that can be
pulled out simply from this table.
...
accel_df %>% 
  ...
  labs(x = "Time of Day", y = "Activity Count", title = "Fig. 9. Daily Activity for Each Day of the Week") +
