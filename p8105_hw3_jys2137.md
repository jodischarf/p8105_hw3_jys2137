...
are purchased *earlier in the day* compared to **coffee ice cream**
purchases. However, Friday seems to be the exception when coffee ice
cream was purchased slightly earlier than pink lady apples at an average
of 12.26.
...
Using this dataset, we do or answer the following (commenting on the
results of each):
